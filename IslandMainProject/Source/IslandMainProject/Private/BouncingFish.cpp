...
void ABouncingFish::GetDamage_Implementation(const FDamageInfo& dInfo)
{
	//Basic reduce health
	float actualDmg;
	...
	// Add on damage effect, like add impulse or add blood effect
	SphereComp->AddImpulseAtLocation( dInfo.DamageDirection* SphereComp->CalculateMass() * dInfo.Damage, dInfo.DamagePoint);
