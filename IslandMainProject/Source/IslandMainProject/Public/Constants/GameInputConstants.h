...
class GameInputConstants
{
	public:
		...
		// Build Cycle Piece
		static const FName CYCLE_BLOCKSET_LEFT;
		static const FName CYCLE_BLOCKSET_RIGHT;

		// Build UI
		static const FName BUILD_TOGGLE_MODE;
		static const FName BUILD_GOTO_SELECT;
		static const FName BUILD_GOTO_OBSERVE;
		static const FName BUILD_GOTO_PLACE;
		static const FName BUILD_GOTO_DELETE;
