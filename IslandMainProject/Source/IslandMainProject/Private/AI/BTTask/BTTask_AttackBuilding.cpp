...
#include "AI/BTTask/BTTask_AttackBuilding.h"
#include "AI/Enemy/EnemyAIControllerBase.h"
#include "AI/Enemy/EnemyBase.h"

#define AttackRange_Sqr 40000

UBTTask_AttackBuilding::UBTTask_AttackBuilding()
{
	bNotifyTick = true;
}

EBTNodeResult::Type UBTTask_AttackBuilding::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_AttackBuilding::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
