...
APickUpBase::APickUpBase()
{
	...
	CapusuleComponent->SetCollisionResponseToChannel(ECC_PhysicsBody, ECR_Block);
	CapusuleComponent->SetSimulatePhysics(true);
	CapusuleComponent->SetCollisionObjectType(ECC_PhysicsBody);
